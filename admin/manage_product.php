    ...
    if (isset($_POST['motherCatEdit'])) {
        ...
        if (isset($_POST['subCatEdit'])) {
            ...
            if (isset($_POST['vendorEdit'])) {
                $vendorid = trim($_POST['vendorEdit']);
                $fillingBool        = (!("" == $subcategory)) &&
                    (!("" == $pro_status)) &&
                    (!("" == $Mothercategory)) &&
                    (!("" == $pro_name)) &&
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="form-group row col-12">
                                                ...
                                                <div class="form-group col-4">
                                                    <label for="selectCat">Select vendor :</label>
                                                    <select class="form-control " name="vendor">
                                                        <option selected="selected" disabled>Vendor name / company</option>
                                                        <?php
                                                        $qurry          = "SELECT * FROM vendor";
                                                        $result         = mysqli_query($conn, $qurry);
                                                        while ($ven     = mysqli_fetch_assoc($result)) {
                                                            echo "<option value='{$ven['vendor_id']}'>{$ven['vendor_company']} / {$ven['vendor_name']} </option>";
                                                        }
                                                        ?>
                                                    </select>
                                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row col-10">
                                    ...
                                    <div class="form-group col-4">
                                        <label for="selectCat">Select vendor :</label>
                                        <select class="form-control " name="vendorEdit">
                                            <option selected="selected" disabled>All vendors</option>
                                            <?php
                                            $qurryv          = "SELECT * FROM vendor";
                                            $resultv         = mysqli_query($conn, $qurryv);
                                            while ($ven1     = mysqli_fetch_assoc($resultv)) {
                                                echo "<option  value='{$ven1['vendor_id']}'>{$ven1['vendor_company']} / {$ven1['vendor_name']} </option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="" method="post" id="upload_multi_imgs" enctype="multipart/form-data">
                    ...
                    <label class="px-5" for="inputGroupFile01">Upload 4 photos at once/ Note:only 4 no less </label>
                        ...
                        <table class="table table-hover progress-table text-center">
                            <thead class="text-uppercase">
                                <tr>
                                    ...
                                    <th scope="col">vendor name/status</th>
                            ...
                            <tbody>
                                ...
                                <td>{$vendorinfo['vendor_name']} / <span class='{$vendorinfo['vendor_status']}2'>{$vendorinfo['vendor_status']}</span></td>
